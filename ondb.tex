...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.55\textwidth]{decomp2.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.43\textwidth]{harder_problems}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.53\textwidth]{harder_problems2}
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.47\textwidth]{conv_dir}
